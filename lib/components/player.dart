...
Hitbox, Collidable{
  ...
  Future<void> _loadAnimations() async {
    ...
    _runLeftAnimation = spriteSheet.createAnimation
      (row: 1, stepTime: _animationSpeed , to: 4);

    _runUpAnimation = spriteSheet.createAnimation
      (row: 2, stepTime: _animationSpeed , to: 4);

    _runRightAnimation = spriteSheet.createAnimation
      (row: 3, stepTime: _animationSpeed , to: 4);
  ...
  void moveLeft(double dt){
    position.sub(Vector2(dt*_playerSpeed , 0));
  }

  void moveUp(double dt){
    position.sub(Vector2(0, dt*_playerSpeed));
  }
